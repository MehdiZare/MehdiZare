const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/mehdizare",
    icon: (
  ...
  {
    label: "GitHub",
    href: "https://github.com/mehdizare",
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: "Seeking Alpha",
    href: "https://seekingalpha.com/author/mehdi-zare",
    icon: (
      <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer className="border-t border-warm-gray bg-paper">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-6 py-12 sm:flex-row sm:items-center lg:px-8">
        <div>
          ...
          <p className="mt-0.5 font-mono text-xs tracking-wide text-mid-gray">
            CFA Charterholder
          </p>
